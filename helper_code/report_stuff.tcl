proc measure_design {KEY_WIDTH DATA_WIDTH HASH_ADR_WIDTH NUMBER_OF_TABLES BUCKET_SIZE BLOCK_DESIGN_FILE_PATH EXPORT_DIRECTORY_PATH} {
    open_bd_design {[expr {$BLOCK_DESIGN_FILE_PATH}]}
...
set BLOCK_DESIGN_FILE_PATH "your_block_file_path"


measure_design $KEY_WIDTH $DATA_WIDTH $HASH_ADR_WIDTH $NUMBER_OF_TABLES $BUCKET_SIZE $BLOCK_DESIGN_FILE_PATH $EXPORT_DIRECTORY_PATH
